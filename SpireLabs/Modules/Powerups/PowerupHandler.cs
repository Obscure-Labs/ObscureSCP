    ...
    internal class PowerupHandler : Module
    {
        ...
        Thread spawnThread = new Thread(() =>
        {
            ...
            while (true)
            {
                ...
                SpawnedPowerupBase spawnedPowerup = new SpawnedPowerupBase(id, powerup, rnd.Next(1, 10), Room.List.GetRandomValue(x => x.Type != RoomType.EzCafeteria || x.Type != RoomType.EzCollapsedTunnel).Position);
