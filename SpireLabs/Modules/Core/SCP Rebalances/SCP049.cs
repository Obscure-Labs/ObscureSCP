namespace ObscureLabs
{
    ...
    internal class Scp049 : Module
    {
        public override string Name => "SCP049";
        ...
        private void OnActivatingSense(ActivatingSenseEventArgs ev)
        {
            ...
            Manager.SendHint(ev.Player, "You provide a <color=#add8e6ff><u>Speed Boost</u></color> to all nearby <color=red><u>SCP Entities</u></color>!", 7);
        ...
        private void OnSendingCall(SendingCallEventArgs ev)
        {
            ...
            Manager.SendHint(ev.Player, "You are giving <color=#add8e6ff><u>HS points</u></color> to all nearby <color=red><u>SCP Entities</u></color>\n<color=yellow>(this can overflow past natural max)</color>", 7);
        ...
        private IEnumerator<float> FixedScpBoostCoroutine(Player player)
        {
            ...
            for (int i = 0; i < 60; i++)
            {
                Manager.SendHint(player, "You provide a<color=#add8e6ff><u>Speed Boost</u></color> to all nearby <color=red><u>SCP Entities</u></color>!", 0.75f);
                foreach (var player1 in Player.List)
                {
                    ...
                    {
                        Manager.SendHint(player2, "You are recieving a <color=#add8e6ff><u>Speed Boost</u></color> from a nearby <color=red><u>SCP 049</u></color>!", 0.75f);
